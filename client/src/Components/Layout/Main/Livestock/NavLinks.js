      ...
      {({onTopicSelect, livestock}) => 
        <Fragment>
          ...
          <List>
            ...
            {livestock.map((topic, index) => <Fragment key={index}>
            ...
            <ListItem button component={Link} to="/gardening" className={listItems} disableRipple>
              <ListItemIcon>
                <img src={require(`../Assets/Vegetables.png`)} height="38" width="38" />
              </ListItemIcon>          
              <Typography variant="h5" className={listName}>
                Gardening
              </Typography>
